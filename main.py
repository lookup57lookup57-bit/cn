...
import os
token = '8150326438:AAG5Z2GWtilwGG6P_LnHtAl9dj3EQywJdSo'
...
by ➜ @AshitaZYN ''', reply_markup=mes)
                                msg = f''' 
𝐂𝐀𝐑𝐃: <code>{cc}</code>
𝐑𝐞𝐬𝐩𝐨𝐧𝐬𝐞: <code>Hit $1.00 ❤️</code>
...
𝐁𝐨𝐭 𝐀𝐛𝐨𝐮𝐭: @AshitaZYN'''
                ...
                print(e)
        bot.edit_message_text(chat_id=message.chat.id, message_id=ko, text='CHECKED ❤️\nBOT BY ➜ @AshitaZYN')
